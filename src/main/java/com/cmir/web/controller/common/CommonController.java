...
import com.cmir.common.utils.file.FileUploadUtils;
import com.cmir.common.utils.file.FileUtils;
import com.cmir.framework.config.ServerConfig;
...
public class CommonController {
  ...
  public void fileDownload(
    ...
    try {
      ...
      String filePath = CmirConfig.getDownloadPath() + fileName;
  ...
  public AjaxResult uploadFile(MultipartFile file) throws Exception {
    try {
      // 上传文件路径
      String filePath = CmirConfig.getUploadPath();
      // 上传并返回新文件名称
  ...
  public void resourceDownload(
    ...
    try {
      ...
      // 本地资源路径
      String localPath = CmirConfig.getProfile();
      // 数据库资源地址
      String downloadPath =
