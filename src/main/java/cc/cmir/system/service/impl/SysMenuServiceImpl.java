package cc.cmir.system.service.impl;

import cc.cmir.common.constant.Constants;
import cc.cmir.common.constant.UserConstants;
import cc.cmir.common.core.domain.TreeSelect;
import cc.cmir.common.core.domain.entity.SysMenu;
import cc.cmir.common.core.domain.entity.SysRole;
import cc.cmir.common.utils.SecurityUtils;
import cc.cmir.common.utils.StringUtils;
import cc.cmir.system.domain.vo.MetaVo;
import cc.cmir.system.domain.vo.RouterVo;
import cc.cmir.system.mapper.SysMenuMapper;
import cc.cmir.system.mapper.SysRoleMapper;
import cc.cmir.system.mapper.SysRoleMenuMapper;
  ...
  public boolean checkRouteConfigUnique(SysMenu menu) {
    ...
    for (SysMenu sysMenu : sysMenuList) {
      if (sysMenu.getMenuId().longValue() != menuId.longValue()) {
        ...
        String dbRouteName =
            StringUtils.isEmpty(sysMenu.getRouteName()) ? dbPath : sysMenu.getRouteName();
        if (StringUtils.equalsAnyIgnoreCase(path, dbPath)
