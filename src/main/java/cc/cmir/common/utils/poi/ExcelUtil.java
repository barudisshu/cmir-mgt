package cc.cmir.common.utils.poi;

import cc.cmir.common.annotation.Excel;
import cc.cmir.common.annotation.Excel.ColumnType;
import cc.cmir.common.annotation.Excel.Type;
import cc.cmir.common.annotation.Excels;
import cc.cmir.common.config.CmirConfig;
import cc.cmir.common.core.domain.AjaxResult;
import cc.cmir.common.core.text.Convert;
import cc.cmir.common.exception.UtilException;
import cc.cmir.common.utils.DateUtils;
import cc.cmir.common.utils.DictUtils;
import cc.cmir.common.utils.StringUtils;
import cc.cmir.common.utils.file.FileTypeUtils;
import cc.cmir.common.utils.file.FileUtils;
import cc.cmir.common.utils.file.ImageUtils;
import cc.cmir.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
  ...
  public void createTitle() {
    if (StringUtils.isNotEmpty(title)) {
      ...
      sheet.addMergedRegion(
          new CellRangeAddress(titleRow.getRowNum(), titleRow.getRowNum(), 0, titleLastCol));
    }
  }
          ...
          if (maxSubListSize > 1 && excel.needMerge()) {
            sheet.addMergedRegion(
                new CellRangeAddress(
                    currentRowNum, currentRowNum + maxSubListSize - 1, column, column));
          }
          column++;
        }
      }
   ...
   * @param endCol 结束列
   */
  public void setXSSFValidationWithHidden(
      Sheet sheet,
      String[] textlist,
      String promptContent,
      int firstRow,
    ...
    try {
      ...
      Method formatMethod =
          excel
              .handler()
              .getMethod(
                  "format", new Class[] {Object.class, String[].class, Cell.class, Workbook.class});
  ...
  public String getAbsoluteFile(String filename) {
    String downloadPath = CmirConfig.getDownloadPath() + filename;
   ...
   */
  public static Map<String, List<PictureData>> getSheetPictures03(
    ...
    if (!pictures.isEmpty() && sheet.getDrawingPatriarch() != null) {
      for (HSSFShape shape : sheet.getDrawingPatriarch().getChildren()) {
        if (shape instanceof HSSFPicture) {
          ...
          sheetIndexPicMap
              .computeIfAbsent(picIndex, k -> new ArrayList<>())
              .add(pic.getPictureData());
        }
      }
    }
   ...
   * @return Map key:图片单元格索引（1_1）String，value:图片流PictureData
   */
  public static Map<String, List<PictureData>> getSheetPictures07(
